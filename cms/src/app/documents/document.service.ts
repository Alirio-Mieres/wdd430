...
export class DocumentService{
  ...
  getDocuments():void {
    this
    .http
    .get('https://wdd-cms-default-rtdb.firebaseio.com//documents.json').subscribe((documents: Documents[]) => {
...
storeDocuments(): void {
  ...
  this
  .http
  .put('https://wdd-cms-default-rtdb.firebaseio.com//documents.json', json, {
    headers: header
  }).subscribe(() => {
    this.documentListChangedEvent.next((this.documents.slice()));
  });
